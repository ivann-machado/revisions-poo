...
--
-- Hôte : localhost:3306
-- Généré le : mar. 14 oct. 2025 à 07:21
...
(1, 'clothing', '', '2025-10-09 13:56:40', '2025-10-09 13:56:40'),
(2, 'electronic', '', '2025-10-09 13:56:40', '2025-10-09 13:56:40');
...
('root', '[{\"db\":\"draft-shop\",\"table\":\"product\"},{\"db\":\"draft-shop\",\"table\":\"electronic\"},{\"db\":\"draft-shop\",\"table\":\"clothing\"},{\"db\":\"draft-shop\",\"table\":\"category\"},{\"db\":\"mediatheque\",\"table\":\"movies\"},{\"db\":\"mediatheque\",\"table\":\"user_stats\"},{\"db\":\"classes\",\"table\":\"category\"},{\"db\":\"mediatheque\",\"table\":\"users\"},{\"db\":\"classes\",\"table\":\"utilisateurs\"}]');
...
('draft-shop', 'clothing', 'product_id', 'draft-shop', 'product', 'id'),
('draft-shop', 'electronic', 'product_id', 'draft-shop', 'product', 'id'),
('draft-shop', 'product', 'category_id', 'draft-shop', 'category', 'id');
...
('draft-shop', 'clothing', 'size'),
('draft-shop', 'electronic', 'brand'),
('draft-shop', 'product', 'name');
...
('root', '2025-10-14 07:21:37', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
...
INSERT INTO `product` (`id`, `category_id`, `name`, `photo`, `price`, `description`, `quantity`, `createdAt`, `updatedAt`) VALUES
(1, 1, 'short en cuir modifié', '', 10, 'Le short en COUIR véritable tout droit de Belgique', 40, '2025-10-09 12:41:19', '2025-10-09 12:41:19'),
(3, 1, 'short en COUIR', '', 10, 'Le short en COUIR véritable tout droit de Belgique', 50, '2025-10-09 13:31:10', '2025-10-09 13:31:10'),
(5, 2, 'supacomputa', '', 10, 'Utra supacomputa', 65, '2025-10-09 14:31:24', '2025-10-09 14:31:24'),
(6, 2, 'supacomputa 3000X', '', 10, 'Utra supacomputa', 50, '2025-10-09 14:32:06', '2025-10-09 14:32:06'),
(7, 2, 'locomputa', '', 10, 'le locomputa', 50, '2025-10-09 14:38:54', '2025-10-09 14:38:54');
